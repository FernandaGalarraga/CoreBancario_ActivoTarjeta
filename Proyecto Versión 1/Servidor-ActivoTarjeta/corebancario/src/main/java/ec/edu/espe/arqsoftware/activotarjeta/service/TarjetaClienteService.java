...
import ec.edu.espe.arqsoftware.activotarjeta.dao.TarjetaClienteRepository;
import ec.edu.espe.arqsoftware.activotarjeta.dao.TarjetaCreditoRepository;
...
import ec.edu.espe.arqsoftware.activotarjeta.model.TarjetaCredito;
...
public class TarjetaClienteService {
    ...
    public TarjetaClienteService(TarjetaClienteRepository tarjetaClienteRepo, TarjetaCreditoRepository tarjetaCreditoRepo) {
    ...
    public String crearTarjetaCliente(TarjetaCliente tarjetaCliente) {
        ...
        LocalDateTime fechaExpedicion = LocalDateTime.now(ZoneId.of("America/New_York")).withNano(0);
